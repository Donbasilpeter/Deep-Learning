...
class ANN:
    ...
    def __create_neural_network(self):
        ...
        self.ann.add(tf.keras.layers.Dense(units=10, activation='relu'))
        # add another hidden layer
        self.ann.add(tf.keras.layers.Dense(units=10, activation='relu'))
        # final layer with one neuron with sigmoid activation function
    ...
    def __train_neural_network(self):
        ...
        """
        self.ann.fit(self.X_train, self.Y_train, batch_size=16, epochs=200)
